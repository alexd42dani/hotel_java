...
public class productos extends javax.swing.JInternalFrame {
    ...
    public productos() {
        ...
        t= (javax.swing.table.DefaultTableModel) tabla_productos.getModel();
        cargar_tabla("producto","");
        combos();
        visible(false);
    ...
    private void initComponents() {
        ...
        combo_unidad_medida = new javax.swing.JComboBox<>();
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(950, 467));
        ...
        tabla_productos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Producto", "Descripcion", "Precio", "Tipo Producto", "Unidad de Medida"
            }
        ) {
        ...
        jRadioButton4.setText("Tipo Producto");

        buttonGroup1.add(jRadioButton5);
        jRadioButton5.setText("U. de Medida");
        ...
        jLabel13.setText("U. de Medida :");

        combo_unidad_medida.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        combo_unidad_medida.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                combo_unidad_medidaFocusGained(evt);
            }
        });
        combo_unidad_medida.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                combo_unidad_medidaPopupMenuWillBecomeInvisible(evt);
            }
            public void popupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {
            }
        });
        combo_unidad_medida.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                combo_unidad_medidaActionPerformed(evt);
            }
        });
        combo_unidad_medida.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                combo_unidad_medidaKeyPressed(evt);
            }
        });

        jLabel2.setText("Tipo Producto :");

        combo_productos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        combo_productos.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                combo_productosFocusGained(evt);
            }
        });
        combo_productos.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                combo_productosPopupMenuWillBecomeInvisible(evt);
            }
            public void popupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {
            }
        });
        ...
        combo_productos.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                combo_productosKeyPressed(evt);
            }
        });
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(combo_productos, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(combo_unidad_medida, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel13)
                    .addComponent(combo_unidad_medida, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txt_producto, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(12, Short.MAX_VALUE))
        );
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGap(3, 3, 3)
                .addComponent(txt_precio, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jPanel10, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE)
                    .addComponent(jPanel9, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE)
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        if(jRadioButton1.isSelected()){
            ...
            cargar_tabla("descripcion","tipo_producto");
        } else if(jRadioButton5.isSelected()){
            cargar_tabla("descripcion","unidad_medida");
        }
        ...
        if (mensaje == 0) {
            try {
                if (tabla_productos.getRowCount() >= 0) {
                    String sql = "DELETE FROM productos WHERE id=" + tabla_productos.getValueAt(tabla_productos.getSelectedRow(), 0).toString() + "";
    ...
    private void btn_grabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_grabarActionPerformed
        ...
        String idTipo_producto = con.BuscaCol("SELECT id FROM tipo_producto WHERE descripcion = '" + combo_productos.getSelectedItem() + "'");
        String id_unidad_medida = con.BuscaCol("SELECT id FROM unidad_de_medida WHERE descripcion = '" + combo_unidad_medida.getSelectedItem() + "'");

        if (banNuevo == 1) {
            guardar(idTipo_producto, id_unidad_medida);
        }
        if (banNuevo == 2) {
            editar(idTipo_producto, id_unidad_medida);
        }
        btn_cancelar.doClick();
    ...
    private void txt_buscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (tabla_productos.getRowCount() == 0) {
                ...
                //de la tabla
                tabla_productos.getSelectionModel().setSelectionInterval(0, 0);
    ...
    private void combo_unidad_medidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_unidad_medidaActionPerformed

    }//GEN-LAST:event_combo_unidad_medidaActionPerformed
    ...
    private void txt_productoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_productoKeyTyped
        con.validar_campos(new int[]{39, 126},"letras_y_numeros", evt, new int[]{164, 165, 209, 241});
    ...
    private void combo_productosKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_combo_productosKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            combo_productos.transferFocus();
        }
    }//GEN-LAST:event_combo_productosKeyPressed

    private void combo_unidad_medidaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_combo_unidad_medidaKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
           txt_producto.requestFocus();
        }
    }//GEN-LAST:event_combo_unidad_medidaKeyPressed

    private void combo_productosPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_combo_productosPopupMenuWillBecomeInvisible
        if (combo_productos.getSelectedIndex()!=-1){
             combo_productos.transferFocus();
            }
    }//GEN-LAST:event_combo_productosPopupMenuWillBecomeInvisible

    private void combo_unidad_medidaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_combo_unidad_medidaFocusGained
        combo_unidad_medida.showPopup();  
    }//GEN-LAST:event_combo_unidad_medidaFocusGained

    private void combo_productosFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_combo_productosFocusGained
        combo_productos.showPopup(); 
    }//GEN-LAST:event_combo_productosFocusGained

    private void combo_unidad_medidaPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_combo_unidad_medidaPopupMenuWillBecomeInvisible
        if (combo_unidad_medida.getSelectedIndex()!=-1){
             txt_producto.requestFocus();
            }
    }//GEN-LAST:event_combo_unidad_medidaPopupMenuWillBecomeInvisible
    ...
    private javax.swing.JComboBox<String> combo_unidad_medida;
    ...
    private void cargar_tabla(String buscar, String boton) {
        ...
        try {
            ...
            sql = "SELECT p.id, p.producto, p.descripcion, p.precio, tp.descripcion, um.descripcion\n" +
                  "FROM productos p\n" +
                  "LEFT JOIN tipo_producto tp ON p.tipo_producto_id = tp.id\n" +
                  "LEFT JOIN unidad_de_medida um ON p.unidad_medida_id = um.id\n" +
                  "WHERE p."+buscar+" LIKE '%"+txt_buscar.getText()+"%' ORDER BY id";
            
            }else if(boton.equals("unidad_medida")){
            
            sql = "SELECT p.id, p.producto, p.descripcion, p.precio, tp.descripcion, um.descripcion\n" +
                  "FROM productos p\n" +
                  "LEFT JOIN tipo_producto tp ON p.tipo_producto_id = tp.id\n" +
                  "LEFT JOIN unidad_de_medida um ON p.unidad_medida_id = um.id\n" +
                  "WHERE um."+buscar+" LIKE '%"+txt_buscar.getText()+"%' ORDER BY id";
            
            }else if(boton.equals("tipo_producto")){
            
            sql = "SELECT p.id, p.producto, p.descripcion, p.precio, tp.descripcion, um.descripcion\n" +
                  "FROM productos p\n" +
                  "LEFT JOIN tipo_producto tp ON p.tipo_producto_id = tp.id\n" +
                  "LEFT JOIN unidad_de_medida um ON p.unidad_medida_id = um.id\n" +
                  "WHERE tp."+buscar+" LIKE '%"+txt_buscar.getText()+"%' ORDER BY id";
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getInt("p.id"), 
                    con.resultado.getString("p.producto"),
                    con.resultado.getString("p.descripcion"),
                    num.format(con.resultado.getInt("p.precio")), con.resultado.getString("tp.descripcion"),
                    con.resultado.getString("um.descripcion")});
    ...
    private void combos() {
        cargaCombo(combo_productos, "SELECT descripcion FROM tipo_producto ORDER BY descripcion");
        cargaCombo(combo_unidad_medida, "SELECT descripcion FROM unidad_de_medida ORDER BY descripcion");
        banPais = 1;
    }
    ...
    private void limpiaTxt() {
        ...
        txt_buscar.setText("");
        txt_precio.setText("");
        combo_unidad_medida.setSelectedIndex(-1);
        ...
        if (tabla_productos.getSelectedRow() >= 0) {
            try {
                String sql = "SELECT * FROM productos "
                        + "WHERE id ='" + tabla_productos.getValueAt(tabla_productos.getSelectedRow(), 0).toString() + "'";
                con.traeQuery(sql);
                if (con.resultado.next()) {
                    txt_producto.setText(con.resultado.getString("producto"));
                    txt_descripcion.setText(con.resultado.getString("descripcion"));
                   
                    txt_precio.setText(num.format(con.resultado.getInt("precio")));
                   
                    combo_unidad_medida.setSelectedItem(con.BuscaCol("SELECT descripcion FROM unidad_de_medida WHERE id = " + con.resultado.getString("unidad_medida_id")));    
                    combo_productos.setSelectedItem(con.BuscaCol("SELECT descripcion FROM tipo_producto WHERE id = " + con.resultado.getString("tipo_producto_id")));
    ...
    private void guardar(String idTipo_producto,String id_unidad_medida) {
        String sql = "INSERT INTO productos "
                + "(producto,descripcion,precio,tipo_producto_id,unidad_medida_id) "
                + "VALUES ( '"+txt_producto.getText()+"' ,'" + txt_descripcion.getText() + "','" + txt_precio.getText().replace(".", "") + "',"
                + "" + idTipo_producto + "," + id_unidad_medida + ") ";
        System.out.println(sql);
        con.actualiza(sql);
    }

    private void editar(String idTipo_producto,String id_unidad_medida) {
        String sql = "UPDATE productos "
                + "SET producto='"+txt_producto.getText()+"', descripcion='" + txt_descripcion.getText() + "' ,precio='" + txt_precio.getText().replace(".", "") + "',"
                + "tipo_producto_id=" + idTipo_producto + ",unidad_medida_id=" + id_unidad_medida + " "
                + "WHERE id='" + tabla_productos.getValueAt(tabla_productos.getSelectedRow(), 0).toString() + "' ";
        System.out.println(sql);
        con.actualiza(sql);
    }
    ...
    private void visible(boolean b) {
        ...
        txt_producto.setEditable(b);
   
        txt_precio.setEditable(b);
    
        combo_unidad_medida.setEnabled(b);
        combo_productos.setEnabled(b);

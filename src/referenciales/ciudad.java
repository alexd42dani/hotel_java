...
public class ciudad extends javax.swing.JInternalFrame {
    ...
    public ciudad() {
        ...
        t= (javax.swing.table.DefaultTableModel) tabla_ciudad.getModel();
        cargar_tabla("descripcion","");
        combos();
        visible(false);
        tabla_ciudad.getTableHeader().setReorderingAllowed(false);
        Botones(false);
    ...
    private void initComponents() {
        ...
        tabla_ciudad.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tabla_ciudadMousePressed(evt);
            }
        });
        tabla_ciudad.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tabla_ciudadKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(tabla_ciudad);
    ...
    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nuevoActionPerformed
        ...
        baneditarnuevo=1;
        txt_buscar.setEnabled(false);
        combo_departamento.requestFocus();
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        if(jRadioButton1.isSelected()){
            ...
            cargar_tabla("departamento","departamento");
        } 
        
    }//GEN-LAST:event_txt_buscarKeyReleased

    private void tabla_ciudadKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_ciudadKeyReleased
       if(baneditarnuevo==0){
        traeFila();
        Botones(true);
       }
    }//GEN-LAST:event_tabla_ciudadKeyReleased
    ...
    private void btn_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_borrarActionPerformed
        ...
        if (mensaje == 0) {
            try {
                if (tabla_ciudad.getRowCount() >= 0) {
                    String sql = "DELETE FROM ciudad WHERE id=" + tabla_ciudad.getValueAt(tabla_ciudad.getSelectedRow(), 0).toString() + "";
    ...
    private void btn_grabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_grabarActionPerformed
        ...
        String idDepartamento = con.BuscaCol("SELECT id FROM departamento WHERE descripcion = '" + combo_departamento.getSelectedItem() + "'");

        if (banNuevo == 1) {
            guardar(idDepartamento);
        }
        if (banNuevo == 2) {
            editar(idDepartamento);
        }
        btn_cancelar.doClick();
    ...
    private void tabla_ciudadMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_ciudadMousePressed
        if(baneditarnuevo==0){
        traeFila();
        Botones(true);
        }
    }//GEN-LAST:event_tabla_ciudadMousePressed
    ...
    private void txt_buscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (tabla_ciudad.getRowCount() == 0) {
                ...
                //de la tabla
                tabla_ciudad.getSelectionModel().setSelectionInterval(0, 0);
                //para enviar el cursor a la tabla
                tabla_ciudad.requestFocus();
            }
        }
    ...
    private void cargar_tabla(String buscar, String boton) {
        ...
        try {
            ...
            sql = "SELECT c.descripcion, c.id, d.descripcion \n" +
                   "FROM ciudad c\n" +
                   "LEFT JOIN departamento d ON d.id = c.idDepartamento\n" +
                   "WHERE c."+buscar+" LIKE '%"+txt_buscar.getText()+"%' ORDER BY id";
            
            }else if(boton.equals("departamento")){
            
            sql = "SELECT c.descripcion, c.id, d.descripcion \n" +
                   "FROM ciudad c\n" +
                   "LEFT JOIN departamento d ON d.id = c.idDepartamento\n" +
                   "WHERE d.descripcion LIKE '%"+txt_buscar.getText()+"%' ORDER BY id";
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getString("c.id"),
    ...
    private void traeFila() {
        int idDepartamento;
        if (tabla_ciudad.getSelectedRow() >= 0) {
            try {
                String sql = "SELECT * FROM ciudad "
                        + "WHERE id ='" + tabla_ciudad.getValueAt(tabla_ciudad.getSelectedRow(), 0).toString() + "'";
                con.traeQuery(sql);
                if (con.resultado.next()) {
                    txt_descripcion.setText(con.resultado.getString("descripcion"));
                    txt_codigo .setText(con.resultado.getString("id"));
                    idDepartamento = con.resultado.getInt("idDepartamento");
                    combo_departamento.setSelectedItem(con.BuscaCol("SELECT descripcion FROM departamento WHERE id = " + idDepartamento));
    ...
    private void guardar(String idDepartamento) {
        String sql = "INSERT INTO ciudad "
                ...
                + "VALUES ('" + txt_descripcion.getText() + "'," + idDepartamento+ " ) ";
        System.out.println(sql);
        con.actualiza(sql);
    }

    private void editar(String idDepartamento) {
        String sql = "UPDATE ciudad "
                + "SET descripcion='" + txt_descripcion.getText()+ "',idDepartamento=" + idDepartamento + " "
                + "WHERE id='" + tabla_ciudad.getValueAt(tabla_ciudad.getSelectedRow(), 0).toString() + "' ";
        System.out.println(sql);
        con.actualiza(sql);
    }

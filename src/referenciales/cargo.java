...
public class cargo extends javax.swing.JInternalFrame {
    ...
    public cargo() {
        ...
        t= (javax.swing.table.DefaultTableModel) tabla_cargo.getModel();
        cargar_tabla("descripcion","");
        visible(false);
        tabla_cargo.getTableHeader().setReorderingAllowed(false);
        Botones(false);
    ...
    private void initComponents() {
        ...
        tabla_cargo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tabla_cargoKeyReleased(evt);
            }
        });
        ...
        jPanel11.setPreferredSize(new java.awt.Dimension(100, 130));
        ...
        txt_departamento.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_departamentoKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_departamento, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jPanel11, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE))
                .addGap(128, 128, 128))
        );
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        if(jRadioButton1.isSelected()){
            ...
            cargar_tabla("departamento","");
        }  
        
    }//GEN-LAST:event_txt_buscarKeyReleased

    private void tabla_cargoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_cargoKeyReleased
       if(baneditarnuevo==0){
        traeFila();
        Botones(true);
       }
    }//GEN-LAST:event_tabla_cargoKeyReleased
    ...
    private void btn_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_borrarActionPerformed
        ...
        if (mensaje == 0) {
            try {
                if (tabla_cargo.getRowCount() >= 0) {
                    String sql = "DELETE FROM cargo WHERE id=" + tabla_cargo.getValueAt(tabla_cargo.getSelectedRow(), 0).toString() + "";
    ...
    private void txt_buscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (tabla_cargo.getRowCount() == 0) {
                ...
                //de la tabla
                tabla_cargo.getSelectionModel().setSelectionInterval(0, 0);
                //para enviar el cursor a la tabla
                tabla_cargo.requestFocus();
            }
        }
    ...
    private void txt_departamentoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_departamentoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            btn_grabar.doClick();
        }
    }//GEN-LAST:event_txt_departamentoKeyPressed
    ...
    private void cargar_tabla(String buscar, String boton) {
        ...
        try {
            ...
            sql = "SELECT descripcion, id, departamento \n" +
                   "FROM cargo \n" +
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getString("id"),
                    ...
                    con.resultado.getString("departamento")});
    ...
    private void traeFila() {
        if (tabla_cargo.getSelectedRow() >= 0) {
            try {
                String sql = "SELECT * FROM cargo "
                        + "WHERE id ='" + tabla_cargo.getValueAt(tabla_cargo.getSelectedRow(), 0).toString() + "'";
                con.traeQuery(sql);
                if (con.resultado.next()) {
                    txt_descripcion.setText(con.resultado.getString("descripcion"));
                    txt_departamento.setText(con.resultado.getString("departamento"));
    ...
    private void guardar() {
        String sql = "INSERT INTO cargo "
                ...
                + "VALUES ('" + txt_descripcion.getText() + "','"+ txt_departamento.getText() +"' ) ";
        System.out.println(sql);
        con.actualiza(sql);
    }
    ...
    private void editar() {
        String sql = "UPDATE cargo "
                + "SET descripcion='" + txt_descripcion.getText()+ "', departamento= '" +txt_departamento.getText() +"' "
                + "WHERE id='" + tabla_cargo.getValueAt(tabla_cargo.getSelectedRow(), 0).toString() + "' ";
        System.out.println(sql);
        con.actualiza(sql);
    }
    ...
    private void visible(boolean b) {
        ...
        txt_departamento.setEditable(b);
    ...
    private boolean vacio() {
        ...
        if (txt_departamento.getText().trim().isEmpty()) {
                nombre="departamento";
                vacio=true;
            }

 ...
 * @author hpnotebook
 */
public class tipo_documento extends javax.swing.JInternalFrame {
    ...
    public tipo_documento() {
        ...
        t= (javax.swing.table.DefaultTableModel) tabla_tipo_documento.getModel();
        cargar_tabla("descripcion","");
        visible(false);
        tabla_tipo_documento.getTableHeader().setReorderingAllowed(false);
        Botones(false);
    ...
    private void initComponents() {
        ...
        tabla_tipo_documento.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tabla_tipo_documentoMousePressed(evt);
            }
        });
        tabla_tipo_documento.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tabla_tipo_documentoKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(tabla_tipo_documento);
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
       banNuevo = 2;
        Botones(true);
        visible(true);
        tabla_tipo_documento.setEnabled(false);
        baneditarnuevo=1;
    ...
    private void tabla_tipo_documentoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_tipo_documentoKeyReleased
       if(baneditarnuevo==0){
        traeFila();
        Botones(true);
       }
    }//GEN-LAST:event_tabla_tipo_documentoKeyReleased
    ...
    private void btn_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_borrarActionPerformed
        ...
        if (mensaje == 0) {
            try {
                if (tabla_tipo_documento.getRowCount() >= 0) {
                    String sql = "DELETE FROM tipo_documento WHERE id=" + tabla_tipo_documento.getValueAt(tabla_tipo_documento.getSelectedRow(), 0).toString() + "";
    ...
    private void btn_cancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelarActionPerformed
       limpiaTxt();
        ...
        Botones(false);
        visible(false);
        tabla_tipo_documento.setEnabled(true);
        cargar_tabla("descripcion","");
        baneditarnuevo=0;
    ...
    private void tabla_tipo_documentoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_tipo_documentoMousePressed
        if(baneditarnuevo==0){
        traeFila();
        Botones(true);
        }
    }//GEN-LAST:event_tabla_tipo_documentoMousePressed
    ...
    private void txt_buscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (tabla_tipo_documento.getRowCount() == 0) {
                ...
                //de la tabla
                tabla_tipo_documento.getSelectionModel().setSelectionInterval(0, 0);
                //para enviar el cursor a la tabla
                tabla_tipo_documento.requestFocus();
            }
        }
    ...
    private void traeFila() {
        if (tabla_tipo_documento.getSelectedRow() >= 0) {
            try {
                String sql = "SELECT * FROM tipo_documento "
                        + "WHERE id ='" + tabla_tipo_documento.getValueAt(tabla_tipo_documento.getSelectedRow(), 0).toString() + "'";
                con.traeQuery(sql);

 ...
 * @author hpnotebook
 */
public class timbrado extends javax.swing.JInternalFrame {
    ...
    public timbrado() {
        ...
        t= (javax.swing.table.DefaultTableModel) tabla_timbrado.getModel();
        cargar_tabla("nro","");
        visible(false);
        tabla_timbrado.getTableHeader().setReorderingAllowed(false);
        Botones(false);
    ...
    private void initComponents() {
        ...
        tabla_timbrado = new javax.swing.JTable();
        ...
        tabla_timbrado.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Codigo", "Numero", "Fecha Desde", "Fecha Fin"
            }
        ) {
        ...
        tabla_timbrado.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tabla_timbradoMousePressed(evt);
            }
        });
        tabla_timbrado.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tabla_timbradoKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(tabla_timbrado);
        ...
        jRadioButton1.setText("Nro");

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("Fecha Inicio");
        ...
        jRadioButton4.setText("Fecha Fin");
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
       banNuevo = 2;
        Botones(true);
        visible(true);
        tabla_timbrado.setEnabled(false);
        baneditarnuevo=1;
    ...
    private void tabla_timbradoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_timbradoKeyReleased
       if(baneditarnuevo==0){
   //     traeFila();
        Botones(true);
       }
    }//GEN-LAST:event_tabla_timbradoKeyReleased
    ...
    private void btn_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_borrarActionPerformed
        ...
        if (mensaje == 0) {
            try {
                if (tabla_timbrado.getRowCount() >= 0) {
                    String sql = "DELETE FROM timbrado WHERE id=" + tabla_timbrado.getValueAt(tabla_timbrado.getSelectedRow(), 0).toString() + "";
    ...
    private void btn_cancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cancelarActionPerformed
       limpiaTxt();
        ...
        Botones(false);
        visible(false);
        tabla_timbrado.setEnabled(true);
        cargar_tabla("nro","");
        baneditarnuevo=0;
    ...
    private void tabla_timbradoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_timbradoMousePressed
      /*  if(baneditarnuevo==0){
        traeFila();
        Botones(true);
        }*/
    }//GEN-LAST:event_tabla_timbradoMousePressed
            ...
            if (tabla_timbrado.getRowCount() == 0) {
                ...
                if(jRadioButton3.isSelected() && !txt_buscar.getText().trim().isEmpty()){
                    if(con.validarFecha(txt_buscar.getText())){
                        cargar_tabla("fecha_desde","fecha");
                    }else{
                ...
                //de la tabla
                tabla_timbrado.getSelectionModel().setSelectionInterval(0, 0);
                //para enviar el cursor a la tabla
                tabla_timbrado.requestFocus();
            }
        }
    ...
    private javax.swing.JTable tabla_timbrado;
    ...
    private void cargar_tabla(String buscar, String boton) {
        ...
        try {
            ...
            sql = "SELECT t.id, t.fecha_desde, t.fecha_fin, t.nro\n" +
                            "FROM timbrado t\n" +
                            "WHERE t."+buscar+" LIKE '%"+txt_buscar.getText()+"%' ORDER BY t.id";
            
            }else if(boton.equals("fecha")){
            
            sql = "SELECT t.id, t.fecha_desde, t.fecha_fin, t.nro\n" +
                            "FROM timbrado t\n" +
                            "WHERE t."+buscar+" LIKE '%"+con.convertir_fecha(txt_buscar.getText())+"%' ORDER BY t.id";
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getInt("t.id"), 
                    ...
                    fec.format(con.resultado.getDate("t.fecha_desde")),
                    fec.format(con.resultado.getDate("t.fecha_fin"))});
...
/*
    private void traeFila() {
        int idCiu;
        if (tabla_timbrado.getSelectedRow() >= 0) {
            try {
                String sql = "SELECT * FROM persona "
                        + "WHERE id ='" + tabla_timbrado.getValueAt(tabla_timbrado.getSelectedRow(), 0).toString() + "'";
                con.traeQuery(sql);
                if (con.resultado.next()) {
                    txt_codigo.setText(con.resultado.getString("nombre"));
    ...
    */
    ...
    private void guardar() {
        String sql = "INSERT INTO timbrado "
                + "(nro,fecha_desde,fecha_fin,estado) "
                + "VALUES ('" + txt_numero.getText() + "','" + con.fechaymd(jDateChooser1.getDate()) + "', "
                + "'" + con.fechaymd(jDateChooser2.getDate()) + "', 'A') ";
        System.out.println(sql);
        con.actualiza(sql);
    }
  ...
  /*  private void editar(String idCiudad, String id_tipoDocumento) {
        String sql = "UPDATE persona "
                + "SET nro_documento='" + txt_documento.getText().replace(".", "") + "', tipo_documento="+id_tipoDocumento+" ,nombre='" + txt_codigo.getText() + "',"

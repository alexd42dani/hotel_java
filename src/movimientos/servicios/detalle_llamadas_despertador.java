 ...
 * @author hpnotebook
 */
public class detalle_llamadas_despertador extends javax.swing.JInternalFrame {
    ...
    SimpleDateFormat fec = new SimpleDateFormat("dd/MM/yyyy");
     ...
     int precio=0;
     String idd="0";
    public detalle_llamadas_despertador(String formulario, String pasar, String iddd) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla_llamadas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Habitacion", "Fecha", "Hora", "Telefono"
            }
        ) {
        ...
        jLabel3.setText("Llamadas Despertador");
           ...
           for (int c1=0; c1<c;c1++){
               for(int f1=0; f1<f;f1++){
                   if(c1==0){
                      ...
                      tabla[f1][c1] = tabla_llamadas.getValueAt(f1,4).toString();
                   }
               }
           }
    ...
    private void btn_agregar_camaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregar_camaActionPerformed
        ...
        }else if (txt_telefono.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe cargar telefono");
    ...
    private void btn_habitacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_habitacionActionPerformed
        menu.llamar_internal(new buscadores.buscador_habitaciones("detalle_llamadas_despertador"));
    ...
    public static void buscador_habitaciones(String id){
     ...
     private void cargar_detalle() {
      ...
      /*  if (cuentaid(idc, tabla_cama, 0) || cuentaid(idh, tabla_cama, 2)) {
            ...
            t.addRow(new Object[]{idh, combo_habitacion.getSelectedItem(),fec.format(jDateChooser1.getDate()),txt_hora.getText(), txt_telefono.getText()});
     ...
     /* private boolean cuentaid(String id,javax.swing.JTable tabla, int posicion) {
      ...
      private void cargar_tabla(String id) {
        ...
        try {
            ...
            sql = "SELECT h.id, h.descripcion, s.fecha, s.hora, s.numero_telefono\n" +
                    "FROM servicios_llamadas_despertador s\n" +
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getInt("h.id"), 
                   ...
                   con.resultado.getString("s.numero_telefono")});

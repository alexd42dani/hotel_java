 ...
 * @author hpnotebook
 */
public class detalle_equipaje extends javax.swing.JInternalFrame {
    ...
    SimpleDateFormat fec = new SimpleDateFormat("dd/MM/yyyy");
     ...
     int precio=0;
     String idd="0";
    public detalle_equipaje(String formulario, String pasar, String iddd) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txt_maletas = new javax.swing.JTextField();
        ...
        tabla_equipaje.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Habitacion", "Maletas", "Cantidad"
            }
        ) {
        ...
        txt_maletas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_maletasKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_maletasKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txt_maletas, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel20)
                            .addComponent(txt_maletas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel21)
    ...
    private void btn_agregar_camaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregar_camaActionPerformed
        if (txt_maletas.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe cargar maleta");
            txt_maletas.requestFocus();
        }else if (txt_cantidad.getText().trim().isEmpty()) {
    ...
    private void btn_habitacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_habitacionActionPerformed
        menu.llamar_internal(new buscadores.buscador_habitaciones("detalle_equipaje"));
    ...
    private void txt_maletasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_maletasKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
          txt_cantidad.requestFocus();
        }
    }//GEN-LAST:event_txt_maletasKeyPressed

    private void txt_maletasKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_maletasKeyTyped
        con.validar_campos(new int[]{39, 126}, "letras_y_numeros", evt, new int[]{47, 164, 165, 209, 241});
    }//GEN-LAST:event_txt_maletasKeyTyped
    ...
    private javax.swing.JTextField txt_maletas;
    ...
    public static void buscador_habitaciones(String id){
     ...
     private void cargar_detalle() {
      ...
      /*  if (cuentaid(idc, tabla_cama, 0) || cuentaid(idh, tabla_cama, 2)) {
            ...
            t.addRow(new Object[]{idh, combo_habitacion.getSelectedItem(),txt_maletas.getText(), txt_cantidad.getText()});
     ...
     /* private boolean cuentaid(String id,javax.swing.JTable tabla, int posicion) {
      ...
      private void cargar_tabla(String id) {
        ...
        try {
            ...
            sql = "SELECT h.id, h.descripcion, s.maletas, s.cantidad\n" +
                    "FROM servicios_equipaje s\n" +
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getInt("h.id"), 
                    ...
                    con.resultado.getString("s.maletas"),

 ...
 * @author hpnotebook
 */
public class detalle_consumicion extends javax.swing.JInternalFrame {
    ...
    SimpleDateFormat fec = new SimpleDateFormat("dd/MM/yyyy");
     ...
     int precio=0;
     String idd="0";
    public detalle_consumicion(String formulario, String pasar, String iddd) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla_consumicion.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "habitacion", "codigo", "producto", "precio", "codigo", "empleado"
            }
        ) {
        ...
        combo_producto.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                combo_productoFocusGained(evt);
            }
        });
        combo_producto.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                combo_productoPopupMenuWillBecomeInvisible(evt);
            }
            public void popupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {
            }
        });
        ...
        combo_producto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                combo_productoKeyPressed(evt);
            }
        });

        btn_producto.setBackground(new java.awt.Color(255, 255, 255));
        btn_producto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos_formularios/buscar3.png"))); // NOI18N
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(combo_producto, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btn_producto, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
           ...
           for (int c1=0; c1<c;c1++){
               for(int f1=0; f1<f;f1++){
                   if(c1==0){
                      ...
                      tabla[f1][c1] = tabla_consumicion.getValueAt(f1,5).toString();
                   }
               }
           }
    ...
    private void btn_agregar_detalleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregar_detalleActionPerformed
        if (combo_empleado.getSelectedIndex() < 0) {
            ...
            combo_habitacion.requestFocus();
        }else if (combo_producto.getSelectedIndex() < 0) {
            JOptionPane.showMessageDialog(null, "Debe seleccionar un producto");
            combo_producto.requestFocus();
        }else {
            cargar_detalle();
            combo_habitacion.requestFocus();
        }
    ...
    private void btn_habitacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_habitacionActionPerformed
     menu.llamar_internal(new buscadores.buscador_habitaciones("detalle_consumicion"));
    ...
    private void btn_limpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_limpiarActionPerformed
       ...
       combo_producto.setSelectedIndex(-1);
    }//GEN-LAST:event_btn_limpiarActionPerformed

    private void combo_productoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_combo_productoFocusGained
        combo_producto.showPopup();
    }//GEN-LAST:event_combo_productoFocusGained

    private void combo_productoPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_combo_productoPopupMenuWillBecomeInvisible
        // TODO add your handling code here:
    }//GEN-LAST:event_combo_productoPopupMenuWillBecomeInvisible

    private void combo_productoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_productoActionPerformed
       if (!id_producto.equals("") && !id_producto.equals("nada")) {
                
                cargaCombo(combo_producto, "SELECT producto FROM productos order by producto", "producto");
       
                combo_producto.setSelectedItem(con.BuscaCol("SELECT producto FROM productos WHERE id = " + id_producto));
                
                
               id_producto="";
               
               
            }else if(id_producto.equals("nada")){
                cargaCombo(combo_producto, "SELECT producto FROM productos order by producto", "producto");
               id_producto="";
            }
    }//GEN-LAST:event_combo_productoActionPerformed

    private void combo_productoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_combo_productoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
         combo_empleado.requestFocus();
         
        }
    }//GEN-LAST:event_combo_productoKeyPressed

    private void btn_productoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_productoActionPerformed
        menu.llamar_internal(new buscadores.buscador_productos("detalle_consumicion"));
    ...
    private void btn_empleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_empleadoActionPerformed
        menu.llamar_internal(new buscadores.buscador_empleado("detalle_consumicion"));
    ...
    private static javax.swing.JComboBox<String> combo_producto;
    ...
    public static void buscador_productos(String id){
        if (!id.equals("")) {
            //System.out.println(id);
            id_producto = id; 
            combo_producto.setSelectedIndex(-1);
    ...
    public static void buscador_empleado(String id){
     ...
     private void cargar_detalle() {
        ...
        String idp = con.BuscaCol("SELECT id \n" +
                                    "FROM productos\n" +
                                    "WHERE producto = '" + combo_producto.getSelectedItem() + "'");
        
        String preciop = con.BuscaCol("SELECT precio \n" +
                                    "FROM productos\n" +
                                    "WHERE producto = '" + combo_producto.getSelectedItem() + "'");
        
       
        preciop = num.format(Integer.parseInt(preciop));
      ...
      /*  if (cuentaid(idc, tabla_cama, 0) || cuentaid(idh, tabla_cama, 2)) {
            ...
            t.addRow(new Object[]{idh, combo_habitacion.getSelectedItem().toString()
                                    ,idp, combo_producto.getSelectedItem().toString(), preciop
     ...
     private void cargar_tabla(String id) {
        ...
        try {
            ...
            sql = "SELECT  h.id, h.descripcion, p.id, p.descripcion, p.precio, e.id, CONCAT(pp.nombre, ' ',pp.apellido)\n" +
                    "FROM servicios_consumicion s\n" +
                    "LEFT JOIN habitaciones h ON s.habitacion_id = h.id\n" +
                    "LEFT JOIN productos p ON s.productos_id = p.id\n" +
                    "LEFT JOIN empleado e ON s.empleado_id = e.id\n" +
                    "LEFT JOIN servicios ss ON s.servicio_id = ss.id\n" +
                    "LEFT JOIN persona pp ON e.persona_id = pp.id\n" +
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getInt("h.id"), 
                    ...
                    con.resultado.getString("p.id"),
                    con.resultado.getString("p.descripcion"),
                    num.format(con.resultado.getInt("p.precio")),
                    //num.format(con.resultado.getInt("p.nro_documento")),
                   con.resultado.getString("e.id"),
                    con.resultado.getString("CONCAT(pp.nombre, ' ',pp.apellido)")});

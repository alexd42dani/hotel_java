 ...
 * @author hpnotebook
 */
public class detalle_lavanderia extends javax.swing.JInternalFrame {
    ...
    SimpleDateFormat fec = new SimpleDateFormat("dd/MM/yyyy");
     ...
     int precio=0;
     String idd="0";
    public detalle_lavanderia(String formulario, String pasar, String iddd) {
        initComponents();
        ((BasicInternalFrameUI) this.getUI()).setNorthPane(null);
        t= (javax.swing.table.DefaultTableModel) tabla_lavanderia.getModel();
       // cargar_tabla("nombre","");
        tabla_lavanderia.getTableHeader().setReorderingAllowed(false);
    ...
    private void initComponents() {
        ...
        tabla_lavanderia = new javax.swing.JTable();
        ...
        txt_prenda = new javax.swing.JTextField();
        ...
        tabla_lavanderia.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        tabla_lavanderia.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tabla_lavanderiaMousePressed(evt);
            }
        });
        tabla_lavanderia.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tabla_lavanderiaKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tabla_lavanderiaKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(tabla_lavanderia);

        jLabel20.setText("Prendas :");
        ...
        txt_prenda.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_prendaKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_prendaKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txt_prenda, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel20)
                            .addComponent(txt_prenda, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(29, 29, 29)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
       ...
       if(tabla_lavanderia.getRowCount()<=0){
           JOptionPane.showMessageDialog(null, "No ha cargado ningun detalle"); 
       
       
       }else{
           
           f = tabla_lavanderia.getRowCount();
           c = 2;
           ...
           for (int c1=0; c1<c;c1++){
               for(int f1=0; f1<f;f1++){
                   if(c1==0){
                      tabla[f1][c1] = tabla_lavanderia.getValueAt(f1,0).toString();
                      //precio += Integer.parseInt(tabla_equipaje.getValueAt(f1,2).toString());
                   }else if(c1==1){
                      tabla[f1][c1] = tabla_lavanderia.getValueAt(f1,2).toString();
                   }
               }
           }
    ...
    private void tabla_lavanderiaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_lavanderiaKeyReleased

    
       
    }//GEN-LAST:event_tabla_lavanderiaKeyReleased
    ...
    private void tabla_lavanderiaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_lavanderiaMousePressed

    }//GEN-LAST:event_tabla_lavanderiaMousePressed

    private void tabla_lavanderiaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_lavanderiaKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            btn_aceptar.doClick();
        }
    }//GEN-LAST:event_tabla_lavanderiaKeyPressed
    ...
    private void btn_agregar_detalleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregar_detalleActionPerformed
        if (txt_prenda.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Debe cargar prenda");
            txt_prenda.requestFocus();
    ...
    private void btn_quitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_quitarActionPerformed
        if (tabla_lavanderia.getSelectedRowCount() == 0) {
            ...
            if (mensaje == 0) {
                javax.swing.table.DefaultTableModel tab = (javax.swing.table.DefaultTableModel) tabla_lavanderia.getModel();
                tab.removeRow(tabla_lavanderia.getSelectedRow());
    ...
    private void btn_habitacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_habitacionActionPerformed
        menu.llamar_internal(new buscadores.buscador_habitaciones("detalle_lavanderia"));
    ...
    private void txt_prendaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_prendaKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
          btn_agregar_detalle.doClick();
        }
    }//GEN-LAST:event_txt_prendaKeyPressed

    private void txt_prendaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_prendaKeyTyped
        con.validar_campos(new int[]{39, 126}, "letras_y_numeros", evt, new int[]{47, 164, 165, 209, 241});
    }//GEN-LAST:event_txt_prendaKeyTyped
    ...
    private javax.swing.JTable tabla_lavanderia;
    private javax.swing.JTextField txt_prenda;
    ...
    public static void buscador_habitaciones(String id){
     ...
     private void cargar_detalle() {
      ...
      /*  if (cuentaid(idc, tabla_cama, 0) || cuentaid(idh, tabla_cama, 2)) {
            ...
            t.addRow(new Object[]{idh, combo_habitacion.getSelectedItem(),txt_prenda.getText()});
     ...
     /* private boolean cuentaid(String id,javax.swing.JTable tabla, int posicion) {
      ...
      private void cargar_tabla(String id) {
        ...
        try {
            ...
            sql = "SELECT h.id, h.descripcion, s.prendas\n" +
                    "FROM servicios_lavanderia s\n" +
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getInt("h.id"), 
                    ...
                    con.resultado.getString("s.prendas")});

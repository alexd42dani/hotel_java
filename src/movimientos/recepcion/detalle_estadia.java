 ...
 * @author hpnotebook
 */
public class detalle_estadia extends javax.swing.JInternalFrame {
    ...
    SimpleDateFormat fec = new SimpleDateFormat("dd/MM/yyyy");
     ...
     int precio=0;
     String idd[];
    public detalle_estadia(String formulario, String pasar, String[] iddd, String pasar1) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Detalle Estadia");
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
       ...
       movimientos.recepcion.estadias.detalle_estadia(null, f, c, precio);
       movimientos.recepcion.estadias.detalle_estadia1(null, f, c, precio);
       }else{
       ...
       if(formulario.equals("estadia")){
           movimientos.recepcion.estadias.detalle_estadia(tabla, f, c, precio);
       }
           ...
           movimientos.recepcion.estadias.detalle_estadia1(tabla, f, c, precio);
       }
    ...
    private void btn_habitacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_habitacionActionPerformed
        menu.llamar_internal(new buscadores.buscador_habitaciones("detalle_estadia"));
    ...
    private void bnt_personaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnt_personaActionPerformed
       menu.llamar_internal(new buscadores.buscador_personas("detalle_estadia"));
    ...
    private void btn_habitacion1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_habitacion1ActionPerformed
       menu.llamar_internal(new buscadores.buscador_habitaciones("detalle_estadia1"));
    ...
    public static void buscador_personas(String id){
     ...
     /* private boolean cuentaid(String id,javax.swing.JTable tabla, int posicion) {
      ...
      private void cargar_tabla_reserva(String id) {

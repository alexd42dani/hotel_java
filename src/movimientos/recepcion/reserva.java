...
public class reserva extends javax.swing.JInternalFrame {
    ...
    movimientos.recepcion.detalle_reserva detalle;
    ...
    private void initComponents() {
        ...
        combo_tipo_reserva = new javax.swing.JComboBox<>();
        ...
        jLabel13.setText("Tipo Reserva :");

        combo_tipo_reserva.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        combo_tipo_reserva.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                combo_tipo_reservaFocusGained(evt);
            }
        });
        combo_tipo_reserva.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                combo_tipo_reservaPopupMenuWillBecomeInvisible(evt);
            }
            public void popupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {
            }
        });
        combo_tipo_reserva.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                combo_tipo_reservaActionPerformed(evt);
            }
        });
        combo_tipo_reserva.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                combo_tipo_reservaKeyPressed(evt);
            }
        });
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addComponent(combo_tipo_reserva, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(62, 62, 62))
        );
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(combo_tipo_reserva, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel13))
        ...
        btn_reserva.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos_formularios/buscar3.png"))); // NOI18N
        btn_reserva.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_reservaesActionPerformed(evt);
            }
        });
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addComponent(btn_reserva, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(12, 12, 12))
        );
    ...
    private void btn_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_borrarActionPerformed
        ...
        if (mensaje == 0) {
            try {
               ...
               sql="delete from reserva_habitaciones where id_reserva =" + txt_codigo.getText() + "";

                
                con.actualiza2(sql);
                
                sql = "DELETE FROM reserva_personas WHERE reservas_id =" + txt_codigo.getText() + "";
                con.actualiza2(sql);
                
                sql = "DELETE FROM reserva_tarifas WHERE id_reserva =" + txt_codigo.getText() + "";
                con.actualiza2(sql);
                
                sql = "DELETE FROM reservas WHERE id =" + txt_codigo.getText() + "";
    ...
    private void btn_grabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_grabarActionPerformed
        ...
        if (vacio() == false) {
            ...
            String tiporeserva = con.BuscaCol("SELECT id FROM tipo_reserva WHERE descripcion='" + combo_tipo_reserva.getSelectedItem() + "'");
            ...
            if (banNuevo == 1) {
                ...
                guardar(idoperador, idtipocliente, tiporeserva, estado);
                btn_cancelar.doClick();
                }
            }
            if (banNuevo == 2) {
                editar(idoperador, idtipocliente, tiporeserva, estado);
                btn_cancelar.doClick();
            }
    ...
    private void combo_tipo_reservaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_tipo_reservaActionPerformed

    }//GEN-LAST:event_combo_tipo_reservaActionPerformed

    private void combo_tipo_reservaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_combo_tipo_reservaKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
           combo_tipo_reserva.transferFocus();
        }
    }//GEN-LAST:event_combo_tipo_reservaKeyPressed

    private void combo_tipo_reservaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_combo_tipo_reservaFocusGained
        combo_tipo_reserva.showPopup();
    }//GEN-LAST:event_combo_tipo_reservaFocusGained

    private void combo_tipo_reservaPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_combo_tipo_reservaPopupMenuWillBecomeInvisible
        if (combo_tipo_reserva.getSelectedIndex() != -1) {
          combo_tipo_reserva.transferFocus();
        }
    }//GEN-LAST:event_combo_tipo_reservaPopupMenuWillBecomeInvisible
    ...
    private void btn_agregar_detalleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregar_detalleActionPerformed
        ...
        if(tabla_tarifas.getRowCount()>0){
            ...
            if (detalle == null ) {
                    ...
                    detalle = new movimientos.recepcion.detalle_reserva("reserva", pasar, idtarifa);
    ...
    private void btn_tarifasesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tarifasesActionPerformed
        menu.llamar_internal(new buscadores.buscador_tarifas("reserva"));
    ...
    private void btn_reservaesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_reservaesActionPerformed
        menu.llamar_internal(new buscadores.buscador_reservas("reserva"));
    }//GEN-LAST:event_btn_reservaesActionPerformed
    ...
    private void txt_precioKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_precioKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            combo_tipo_reserva.requestFocus();
        }
    ...
    private javax.swing.JComboBox<String> combo_tipo_reserva;
    ...
    private void combos() {
        ...
        cargaCombo(combo_tipo_reserva, "SELECT descripcion FROM tipo_reserva ORDER BY descripcion", "descripcion");
        cargaCombo(combo_tarifas, "SELECT CONCAT(f.id,'-',tn.descripcion)\n" +
                                    "FROM tarifas f\n" +
                                    "LEFT JOIN tarifas_nombres tn ON f.tarifas_nombres_id = tn.id\n" +
                                    "LEFT JOIN habitaciones h ON f.habitacion_id = h.id\n" +
    ...
    private void limpiaTxt() {
        ...
        combo_tipo_reserva.setSelectedIndex(-1);
        combo_tarifas.setSelectedIndex(-1);
        combo_estado.setSelectedIndex(-1);
        ...
        try {
            ...
            if (con.resultado.next()) {
               ...
               // idhabitacion = con.resultado.getInt("id");
                ...
                combo_tipo_reserva.setSelectedItem(con.BuscaCol("SELECT descripcion FROM tipo_reserva WHERE id = " + con.resultado.getString("tipo_reserva_id")));
    ...
    private void guardar(String idoperador, String idtipocliente, String tiporeserva, String estado) {
        try {
            String sql = "INSERT INTO reservas "
                    + "(id_operador,comentarios,precio,Estado,tipo_cliente_id,usuario_id,tipo_reserva_id,fecha) "
            ...
            for (int i = 0; i < cf; i++) {
                ...
                sql = " Insert into reserva_tarifas (id_reserva, id_tarifa) "
                        + "values (" + id + ", "
               ...
               if(tabla!=null){
                ...
                for (int f1 = 0; f1 < f; f1++) {
                    ...
                    sql = " Insert into reserva_habitaciones (id_reserva,id_habitaciones,entrada,salida,hora_entrada,hora_salida) "
                            + "values ( " + id + ", "
               ...
               if(tabla1!=null){
                ...
                for (int f1 = 0; f1 < this.f1; f1++) {
                    ...
                    sql = " Insert into reserva_personas (persona_id,reservas_id,habitacion_id) "
                            + "values (" + tabla1[f1][0] + "," + id + ", " + tabla1[f1][1] + " )";
    ...
    private void editar(String idoperador, String idtipocliente, String tiporeserva, String estado) {
            String sql = "UPDATE reservas  "
                    ...
                    + " , usuario_id=" + 1 + ", tipo_reserva_id=" + tiporeserva + ", fecha='" + con.fechaymd(jDateChooser.getDate()) + "'"
    ...
    private void visible(boolean b) {
      ...
      //  txt_precio.setEditable(b);
       // jDateChooser.setEnabled(b);
        ...
        combo_tipo_reserva.setEnabled(b);
    ...
    public static void detalle_reserva(String tabla1[][], int f1, int c1, int precio1) {
            //System.out.println(id);
            f = f1;
            c = c1;
            tabla = tabla1;
    ...
    public static void detalle_reserva1(String tabla11[][], int f11, int c11, int precio1) {
            //System.out.println(id);
            f1 = f11;
            c1 = c11;
            tabla1 = tabla11;

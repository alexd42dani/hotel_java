 ...
 * @author hpnotebook
 */
public class buscador_reservas extends javax.swing.JInternalFrame {
    ...
    public buscador_reservas(String formulario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Buscador de Reservas");
    ...
    private void cargar_tabla(String buscar, String boton) {
        ...
        try {
            ...
            sql = "SELECT r.reservas_id, p.nombre, p.apellido, p.nro_documento, rh.entrada, rh.salida, h.descripcion\n" +
                    "FROM reserva_personas r\n" +
                    "LEFT JOIN reserva_habitaciones rh ON rh.id_reserva = r.reservas_id\n" +
                    "LEFT JOIN persona p ON p.id = r.persona_id\n" +
                    "LEFT JOIN habitaciones h ON h.id = rh.id_habitaciones\n" +
                    "LEFT JOIN reservas rr ON rr.id = r.reservas_id\n" +
                    "WHERE p."+buscar+" LIKE '%"+txt_buscar.getText()+"%' and rr.Estado = 'A' ORDER BY r.reservas_id";
            ...
            sql = "SELECT r.reservas_id, p.nombre, p.apellido, p.nro_documento, rh.entrada, rh.salida, h.descripcion\n" +
                    ...
                    "LEFT JOIN habitaciones h ON h.id = rh.id_habitaciones\n" +
                    "LEFT JOIN reservas rr ON rr.id = r.reservas_id\n" +
                            "WHERE rh."+buscar+" LIKE '%"+con.convertir_fecha(txt_buscar.getText())+"%' and rr.Estado = 'A' ORDER BY r.reservas_id";
            ...
            sql = "SELECT r.reservas_id, p.nombre, p.apellido, p.nro_documento, rh.entrada, rh.salida, h.descripcion\n" +
                    ...
                    "LEFT JOIN habitaciones h ON h.id = rh.id_habitaciones\n" +
                    "LEFT JOIN reservas rr ON rr.id = r.reservas_id\n" +
                    "WHERE h."+buscar+" LIKE '%"+txt_buscar.getText()+"%' and rr.Estado = 'A' ORDER BY r.reservas_id";
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getInt("r.reservas_id"), 
                    con.resultado.getString("p.nombre")+" "+con.resultado.getString("p.apellido"),
                    num.format(con.resultado.getInt("p.nro_documento")),
                    fec.format(con.resultado.getDate("rh.entrada")),
                    fec.format(con.resultado.getDate("rh.salida")),
            ...
            Logger.getLogger(buscador_reservas.class.getName()).log(Level.SEVERE, null, ex);
        }
}

    private void pasar() {
        if(formulario.equals("reserva")){
           movimientos.recepcion.reserva.buscador_reserva(id_tabla);
       }else if(formulario.equals("estadia")){
           movimientos.recepcion.estadias.buscador_reserva(id_tabla);
       }
    }

 ...
 * @author hpnotebook
 */
public class buscador_estadia extends javax.swing.JInternalFrame {
    ...
    public buscador_estadia(String formulario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla_personas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre y Apellido", "Documento", "Entrada", "Salida", "Habitacion"
            }
        ) {
        ...
        jRadioButton6.setText("Descripcion");
        ...
        jLabel3.setText("Buscador de Estadia");
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        if(jRadioButton1.isSelected()){
            ...
            cargar_tabla("descripcion","habitaciones");
        }
            ...
            if (tabla_personas.getRowCount() == 0) {
                ...
                if(jRadioButton4.isSelected() && !txt_buscar.getText().trim().isEmpty()){
                    if(con.validarFecha(txt_buscar.getText())){
                        cargar_tabla("entrada","entrada");
                    }else{
                    JOptionPane.showMessageDialog(null, "No es una fecha");
                    txt_buscar.setText("");
                    }
                }
                if(jRadioButton5.isSelected() && !txt_buscar.getText().trim().isEmpty()){
                    if(con.validarFecha(txt_buscar.getText())){
                        cargar_tabla("salida","salida");
                    }else{
                    JOptionPane.showMessageDialog(null, "No es una fecha");
                    txt_buscar.setText("");
                    }
    ...
    private void cargar_tabla(String buscar, String boton) {
        ...
        try {
            ...
            sql = "SELECT e.id_estadia, p.nombre, p.apellido, p.nro_documento, eh.entrada, eh.salida, hh.descripcion\n" +
                    "FROM estadia_huespedes e\n" +
                    "LEFT JOIN estadia_habitaciones eh ON eh.id_estadia = e.id_estadia\n" +
                    "LEFT JOIN huespedes h ON h.id = e.huespedes_id\n" +
                    "LEFT JOIN persona p ON p.id = h.persona_id\n" +
                    "LEFT JOIN habitaciones hh ON hh.id = eh.id_habitacion \n" +
                    "LEFT JOIN estadia rr ON rr.id = e.id_estadia\n" +
                    "WHERE p."+buscar+" LIKE '%"+txt_buscar.getText()+"%' and rr.estado = 'A' ORDER BY e.id_estadia";
            
            }else if(boton.equals("entrada")){
            ...
            sql = "SELECT e.id_estadia, p.nombre, p.apellido, p.nro_documento, eh.entrada, eh.salida, hh.descripcion\n" +
                    ...
                    "LEFT JOIN habitaciones hh ON hh.id = eh.id_habitacion \n" +
                    "LEFT JOIN estadia rr ON rr.id = e.id_estadia\n" +
                            "WHERE eh."+buscar+" LIKE '%"+con.convertir_fecha(txt_buscar.getText())+"%' and rr.estado = 'A' ORDER BY e.id_estadia";
            
            }else if(boton.equals("salida")){
            ...
            }else if(boton.equals("habitaciones")){
            ...
            sql = "SELECT e.id_estadia, p.nombre, p.apellido, p.nro_documento, eh.entrada, eh.salida, hh.descripcion\n" +
                    ...
                    "LEFT JOIN habitaciones hh ON hh.id = eh.id_habitacion \n" +
                    "LEFT JOIN estadia rr ON rr.id = e.id_estadia\n" +
                    "WHERE hh."+buscar+" LIKE '%"+txt_buscar.getText()+"%' and rr.estado = 'A' ORDER BY e.id_estadia";
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getInt("e.id_estadia"), 
                    con.resultado.getString("p.nombre")+" "+con.resultado.getString("p.apellido"),
                    num.format(con.resultado.getInt("p.nro_documento")),
                    fec.format(con.resultado.getDate("eh.entrada")),
                    fec.format(con.resultado.getDate("eh.salida")),
            ...
            Logger.getLogger(buscador_estadia.class.getName()).log(Level.SEVERE, null, ex);
        }
}

    private void pasar() {
        if(formulario.equals("estadia")){
           movimientos.recepcion.estadias.buscador_estadia(id_tabla);
       }else if(formulario.equals("facturas")){
           movimientos.facturacion.facturas.buscador_estadia(id_tabla);
       }
    }

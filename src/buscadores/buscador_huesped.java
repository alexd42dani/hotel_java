 ...
 * @author hpnotebook
 */
public class buscador_huesped extends javax.swing.JInternalFrame {
    ...
    public buscador_huesped(String formulario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla_huespedes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre y Apellido", "Cedula", "Profesion"
            }
        ) {
        ...
        jRadioButton4.setText("Profesion");
        ...
        jLabel3.setText("Buscador de Huespedes");
    ...
    private void btn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregarActionPerformed
        menu.menu.llamar_internal(new referenciales.huespedes());
    }//GEN-LAST:event_btn_agregarActionPerformed

    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
       // referenciales.huespedes.buscador_personas("1");
       if(tabla_huespedes.getSelectedRow()>-1){
       id_tabla= tabla_huespedes.getValueAt(tabla_huespedes.getSelectedRow(), 0).toString();
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
       if(jRadioButton1.isSelected()){
            ...
            cargar_tabla("profesion","profesion");
        }
    ...
    private void tabla_huespedesKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_huespedesKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            btn_aceptar.doClick();
        }
    }//GEN-LAST:event_tabla_huespedesKeyPressed
    ...
    private void cargar_tabla(String buscar, String boton) {
        ...
        try {
            ...
            sql = "SELECT h.id, p.nro_documento, p.nombre, p.apellido, p.telefono, p.email, p.direccion,\n" +
                   ...
                   "WHERE p."+buscar+" LIKE '%"+txt_buscar.getText()+"%' and e.estado = 'A' ORDER BY id";
            
            }else if(boton.equals("profesion")){
            ...
            sql = "SELECT h.id, p.nro_documento, p.nombre, p.apellido, p.telefono, p.email, p.direccion,\n" +
                    ...
                    "LEFT JOIN estadia_huespedes eh ON eh.huespedes_id = h.id\n" +
                    "LEFT JOIN estadia e ON e.id = eh.id_estadia\n" +
                   "WHERE h."+buscar+" LIKE '%"+ txt_buscar.getText()+"%' and e.estado = 'A' ORDER BY id";
            ...
            Logger.getLogger(buscador_huesped.class.getName()).log(Level.SEVERE, null, ex);
        }
}

    private void pasar() {
        if(formulario.equals("servicios")){
           movimientos.servicios.servicios.buscador_huespedes(id_tabla);
       }else if(formulario.equals("facturas")){
           movimientos.facturacion.facturas.buscador_huesped(id_tabla);
       }
    }

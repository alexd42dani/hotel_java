 ...
 * @author hpnotebook
 */
public class buscador_apertura extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tabla_factura.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Id caja", "Caja", "Fec Apertura", "Hora Apertura", "Saldo Inicial"
            }
        ) {
        ...
        jRadioButton1.setText("Cod caja");
        ...
        jRadioButton3.setText("Fec Apertura");

        buttonGroup1.add(jRadioButton4);
        jRadioButton4.setText("Hora Apertura");
        ...
        jLabel3.setText("Buscador de Apertura");
...
//       precio = Integer.parseInt(tabla_factura.getValueAt(tabla_factura.getSelectedRow(), 8).toString().replace(".", ""));
    ...
    private void txt_buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyReleased
        if(jRadioButton1.isSelected()){
            ...
            cargar_tabla("descripcion","caja");
        } else if(jRadioButton3.isSelected()){
           // cargar_tabla("fecha_apertura","");
        } else if(jRadioButton4.isSelected()){
            cargar_tabla("hora_apertura","");
        }else if(jRadioButton8.isSelected()){
                cargar_tabla("saldo_inicial","");
        }
            ...
            if (tabla_factura.getRowCount() == 0) {
                ...
                if(jRadioButton3.isSelected() && !txt_buscar.getText().trim().isEmpty()){
                    if(con.validarFecha(txt_buscar.getText())){
                        cargar_tabla("fecha_apertura","fecha");
                    }else{
        ...
        if(jRadioButton1.isSelected()){
           ...
           con.validar_campos(new int[]{39, 126},"letras_y_numeros", evt, new int[]{47, 164, 165, 209, 241});
            ...
            //cargar_tabla("fecha_nacimiento","fecha");
             // con.validar_campos(new int[]{39, 126},"letras_y_numeros", evt, new int[]{47, 164, 165, 209, 241});
             con.validar_campos("numeros", evt, new int[]{58});
        }else if(jRadioButton8.isSelected()){   
           // cargar_tabla("apellido","");
          con.validar_campos("numeros", evt);
        }
    ...
    private void cargar_tabla(String buscar, String boton) {
        ...
        try {
            ...
            sql = "SELECT a.id, a.caja_id, c.descripcion, a.fecha_apertura,\n" +
                    "a.hora_apertura, a.saldo_inicial\n" +
                    "FROM apertura_cierre a\n" +
                    "LEFT JOIN caja c ON c.id = a.caja_id\n" +
                    "WHERE a.fecha_cierre = '0001-01-01'\n" +
                    "and a."+buscar+" LIKE '%"+txt_buscar.getText()+"%'  ORDER BY a.id";
            
            }else if(boton.equals("caja")){
            ...
            sql = "SELECT a.id, a.caja_id, c.descripcion, a.fecha_apertura,\n" +
                    ...
                    "LEFT JOIN caja c ON c.id = a.caja_id\n" +
                    "WHERE a.fecha_cierre = '0001-01-01'\n" +
                    "and c."+buscar+" LIKE '%"+txt_buscar.getText()+"%'  ORDER BY a.id";
            ...
            sql = "SELECT a.id, a.caja_id, c.descripcion, a.fecha_apertura,\n" +
                    ...
                    "LEFT JOIN caja c ON c.id = a.caja_id\n" +
                    "WHERE a.fecha_cierre = '0001-01-01'\n" +
                    "and a."+buscar+" LIKE '%"+con.convertir_fecha(txt_buscar.getText())+"%' ORDER BY a.id";
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{
                    con.resultado.getInt("a.id"),
                    con.resultado.getInt("a.caja_id"),
                    con.resultado.getString("c.descripcion"),
                    fec.format(con.resultado.getDate("a.fecha_apertura")),
                    con.resultado.getString("a.hora_apertura"),
                    num.format(con.resultado.getInt("a.saldo_inicial"))
                });
            ...
            Logger.getLogger(buscador_apertura.class.getName()).log(Level.SEVERE, null, ex);
        }
}

    private void pasar() {
        if(formulario.equals("apertura_cierre")){
           movimientos.cobros.apertura_cierre.buscador_apertura(id_tabla);
       }else if(formulario.equals("cobros")){
           movimientos.cobros.cobros.buscador_apertura(id_tabla);
       }
    }

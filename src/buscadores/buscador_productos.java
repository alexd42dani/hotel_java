 ...
 * @author hpnotebook
 */
public class buscador_productos extends javax.swing.JInternalFrame {
    ...
    public buscador_productos(String formulario) {
        initComponents();
    ...
    private void btn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregarActionPerformed
        menu.menu.llamar_internal(new referenciales.productos());
        ...
        try {
            ...
            while (con.resultado.next()) {
                t.addRow(new Object[]{con.resultado.getInt("p.id"), 
                    ...
                    con.resultado.getString("p.precio"),
                    con.resultado.getString("tp.descripcion"),
            ...
            Logger.getLogger(buscador_productos.class.getName()).log(Level.SEVERE, null, ex);
        }
}

    private void pasar() {
        if(formulario.equals("detalle_consumicion")){
           movimientos.servicios.detalle_consumicion.buscador_productos(id_tabla);
       }
